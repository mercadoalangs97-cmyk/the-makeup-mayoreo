...
export const LOTES: Lote[] = [
  ...
  },
  {
    ...
    desc: "Para distribuidoras. El precio por pieza mas bajo: $91 MXN. Solo por WhatsApp.",
    features: [
      "500 piezas de marcas premium",
      "Precio mas bajo: $91 MXN/pieza",
