...
export const LOTES: Lote[] = [
  {
    ...
    desc: "Lote mixto de maquillaje importado EE.UU. Marcas como e.l.f, NYX, Maybelline y mas. Ideal para empezar.",
    features: [
      "10 piezas importadas EE.UU.",
  ...
  },
  {
    ...
    desc: "Lote mixto con marcas premium. Gran variedad de categorias importadas de EE.UU.",
    features: [
      "15 piezas importadas EE.UU.",
  ...
  },
  {
    ...
    desc: "Lote mixto con gran variedad: labiales, bases, sombras, primers y mas. Todo importado de EE.UU.",
    features: [
      "20 piezas importadas EE.UU.",
  ...
  },
  {
    ...
    desc: "Lote mixto completo: maquillaje, skincare y accesorios. Marcas premium importadas de EE.UU.",
    features: [
      "30 piezas importadas EE.UU.",
  ...
  },
  {
    ...
    wppOnly: true,
    foto: null,
    desc: "Lote especializado en labiales importados. Colores variados, mate y glossy. Solo por WhatsApp.",
    features: [
      "20 labiales importados EE.UU.",
