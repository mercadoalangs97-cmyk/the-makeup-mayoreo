...
export const metadata: Metadata = {
  title: "Aviso de Privacidad · The Makeup / AMAREA",
  description:
    "Aviso de Privacidad de The Makeup / AMAREA: qué datos recabamos, para qué los usamos y cómo ejercer tus derechos ARCO.",
